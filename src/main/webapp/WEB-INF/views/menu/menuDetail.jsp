  	        ...
  	        <section class="page1" id="1">
                    <div class="product_warp">
                        <div class="product_img">
                            <img src="${path }${pdto.img_desc }" alt="ds_img">
                        </div>
                        ...
                        <div class="product_detail">
                            <table class="detail_table">
                                <tbody>
                                    <tr>
                                        <th colspan="2" style="font-size: 25px; font-weight: 500;">
                                        <span>${pdto.pname }</span>
                                        <p>${pdto.psubname }</p>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th class="detail_price" colspan="2" style="font-size: 25px; font-weight: 600;">
                                            <fmt:formatNumber value="${pdto.price }" pattern="#,###" /> <span style="font-size: 13px;">원</span></th>
                                    </tr>
                                   ...
                                   <tr class="product_tr">
                                    ...
                                    <tr>
                                        ...
                                        <td class="detail_text_sub_last" style="font-size: 25px; font-weight: 600;">
                                            <span class="sum"><fmt:formatNumber value="${pdto.price }" pattern="#,###" /></span><span style="font-size: 13px;">원</span>
                                            <input type="hidden" value="${pdto.price }" name="price" id="price" class="origin_sum">
                                            <input type="hidden" value="${pdto.pcode }" name="pcode" id="pcode">
										</td>
                                    </tr>
                                </tbody>
                            </table>
							<div style="display:flex;margin-left:100px;">
								...
								<button class="pickup_btn" onclick="basketList();">장바구니담기</button>
								<button class="buy_btn" onclick="order();">구매하기</button>
							</div>
                        </div>
                    </div>
                                ...
                                <div class="view_whyBn2U_tit">
                                    ...
                                    <div class="view_whyBn2U_img">
                                        <div class="whyBn2U_item" style="margin-right: 50px;">
                                            <figure>
                                                <img src="${path}/resources/img/menu1/01_check.svg" alt="img">
                                            </figure>
                                            <h4>깐깐한 상품위원회</h4>
                                        ...
                                        <div class="whyBn2U_item" style="margin-right: 50px; margin-bottom: 50px;">
                                            <figure>
                                                <img src="${path}/resources/img/menu1/02_only.svg" alt="img">
                                            </figure>
                                        ...
                                        <div class="whyBn2U_item">
                                            <figure>
                                                <img src="${path}/resources/img/menu1/03_cold.svg" alt="img">
                                            </figure>
                                            <h4>신선한 풀콜드체인 배송</h4>
                                            <p class="view_whyBn2U_sub_tit">
                                        ...
                                        <div class="whyBn2U_item" style="margin-right: 50px;">
                                            <figure>
                                                <img src="${path}/resources/img/menu1/04_price.svg" alt="img">
                                            </figure>
                                        ...
                                        <div class="whyBn2U_item">
                                            <figure>
                                                <img src="${path}/resources/img/menu1/05_eco.svg" alt="img">
                                            </figure>
...
var origin_sum_val = parseInt($('.origin_sum').val());
		...
		<script>
			function basketList(){
				...
				var pcode = $('#pcode').val();
				var cus_seq = ${sseq }
				location.href="${path }/basket/addBasket?cus_seq="+cus_seq+"&pcode="+pcode+"&qty="+qty;
			}
			...
			function order(){
				...
				var pcode = $('#pcode').val();
				var cus_seq = ${sseq }
				location.href="${path }/order/order?cus_seq="+cus_seq+"&pcode="+pcode+"&qty="+qty;
			}
